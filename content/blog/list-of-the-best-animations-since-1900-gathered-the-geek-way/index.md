...
In the midst of our random data┬áexploration, Laure and I┬ástarted playing around with Hadley&#8217;s movies dataset and noticed that there were a lot of old cartoon animations&#8230; I mean REALLY old. So we┬ágot excited and wondered if we could find Youtube links for all these old animations. Indeed we could! Here&#8217;s how we did it. As always, the full analysis <a href="https://github.com/datastrategist/Search-engine-scraping-and-stringmatching" target="_blank">is on github</a>.

  1. In R, Load in `ggplot2movies::movies`, which has something like 60 000 movies
  2. Reduce this dataset┬áto animations of only 10 minutes or less and┬áthen arrange by year and descending rating, then select only┬á<del>1 best animation per year</del>. Hrm&#8230; actually, select each year&#8217;s 3 best-rated cartoons. You&#8217;ll see why later.┬áThis reduced dataset has <300 rows&#8230; much more manageable. Of this, only keep the title and year, you don&#8217;t need the rest.
  ...
  8. Based on an evaluation of the string distances and percents, ┬áwe realized that very few cartoons have good correspondence between the title looked for and the title found.This is why one movie per year doesn&#8217;t work and we had to┬ágo back and select the 3 best cartoons.
...
### Final thoughts
  ...
  * We tried to find the images for each video entice viewers to watch the cartoon, but this was reeeeeally hard to do! All the search engines we found push the images as data or in iframes so we couldn&#8217;t capture the image with GET. We finally gave up ≡ƒÖü
  * We could have probably found ┬ámore hits if we had looked at more movie sites than youtube, but we didn&#8217;t like the idea of going to whatever site&#8230; who knows what ads they might have popup or whatever.
