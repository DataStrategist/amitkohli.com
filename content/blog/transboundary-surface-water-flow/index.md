...
---
A visualization generated┬áfor AQUASTAT of FAO.
...
Two types of charts┬áwere prepared:┬áSankey and Network. The Sankey plots allow for an &#8216;automatic sorting&#8217; of countries based on who is the water tower and who is the water source. This visualization is useful to demonstrate where a country falls on this continuum.

The network plot shows the┬áautomatic arrangement of countries with┬átheir &#8216;water-neighbours&#8217;┬áwithout being bound┬áto┬áthe upstream (left) -> downstream (right) style.

See interactive versions for┬áall continents as well as a detailed analysis on the AQUASTAT page:
